class StoreChainsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.json  { render :json => @store_chains }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.json  { render :json => @store_chain }
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @store_chain.save
        format.html { redirect_to(@store_chain, :notice => 'Store chain was successfully created.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(store_chains_url) }
      format.xml  { head :ok }
    end
  end
end
